...
function cargarProductos() {
    fetch('https://raw.githubusercontent.com/fernandos97/Vivero-El-Brote/main/js/productos.json')
...
function actualizarCarrito() {
    ...
    contenedorCarrito.innerHTML += `
        ...
        <p>${producto.nombre}</p>
            ...
            <button onclick=eliminarProducto(${
              producto.id
            }) class="boton-eliminar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
  ...
  let ingresarPrecioTotal = carrito.reduce(
